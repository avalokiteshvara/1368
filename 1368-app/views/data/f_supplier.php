      ...
      <div class="panel panel-info">
         ...
         <div class="panel-body">
            <div class="col-lg-12">
              ...
              <?php } ?>
               <form action="<?php echo base_url() . 'data/supplier/' . $act;?>" method="post" accept-charset="utf-8" autocomplete="off">
                  <div class="col-lg-6">
                     <table  class="table-form">
                        ...
                        <tr>
                           <td>Alamat Kantor</td>
                           <td><textarea name="alamat" required id="alamat" class="form-control col-lg-8" tabindex="2"><?php echo $alamat;?></textarea></td>
                        </tr>                        
                        <tr>
                  ...
                  <div class="col-lg-12" style="margin-left: 252px;margin-top: 20px">
                     <a href="<?php echo base_url() . 'data/supplier'?>" class="btn btn-success" tabindex="11"><i class="fa fa-arrow-circle-left"></i> Kembali</a>

         ...
         <div class="panel-heading">
            <div class="navbar-header">
               ...
               <ul class="nav navbar-nav">
                  <li><a data-original-title="" href="<?php echo base_url() . 'pesan/keluar/add'?>" class="btn-info"><i class="fa fa-plus fa-fw"> </i> Buat Pesan</a></li>
               </ul>

            </div>
            <div class="navbar-collapse collapse navbar-inverse-collapse" >
               <ul class="nav navbar-nav navbar-right">
                  <form class="navbar-form" method="post" action="<?php echo base_url() . 'pesan/keluar/cari';?>">
                     ...
                     <a href="<?php echo base_url() . 'pesan/keluar/clear_search'?>"><button type="button" class="btn btn-info"><i class="fa fa-times fa-fw"> </i> Clear</button></a>
                  </form>
               </ul>
            </div>
            <!-- /.nav-collapse -->
                        ...
                        <tbody>
                           ...
                           <?php }else{ ?>
                             ...
                             <tr>
                                ...
                                <!--<td><pre><?php echo $r->status;?></pre></td>-->
                                ...
                                <td class="ctr">
                                   <div class="btn-group">
                                      ...
                                      <a style="margin-right: 10px" href="<?php echo base_url() . 'pesan/keluar/del/' . $r->id;?>" class="btn btn-danger btn-sm" title="" onClick="return confirm('Anda yakin ingin menghapus data ini?')"><i class="fa fa-trash">  </i> Hapus</a>
                                   </div>
                                </td>
                             </tr>
                             <?php } ?>
            ...
            <div class="modal-body">
               <table width="100%" class="table-form" align="center">                  
                  ...
                  <tr>
                     ...
                     <td><input type="text" id="penerima" class="form-control col-lg-8"></td>
                  </tr>
                  <tr>
                     <td width="20%">Subyek</td>
                     <td><input type="text" id="subyek" class="form-control col-lg-8"></td>
                  </tr>
                  <!--<tr>-->
                  ...
                  <tr>
                     ...
                     <td>
                      <!--  <textarea id="tinyMCE" class="form-control col-lg-8"></textarea>-->
...
<script type="text/javascript">
   ...
   {  
      $.get("<?php echo base_URL(); ?>pesan/keluar/read/" + id_pesan,
